...
nlForm.addEventListener("submit", (e) => {
 ...
 nlFeedback.textContent = "Thanks! You’ve been added to the Newsletter/Listserv
(demo).";
...
ctFeedback.className = "feedback error"; ctName.focus(); return; }
 if (!isLikelyEmail(fromEmail)) { ctFeedback.textContent = "Please enter a valid
email address."; ctFeedback.className = "feedback error"; ctEmail.focus(); return; }
